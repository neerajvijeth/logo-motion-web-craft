...
const HeroSection = () => {
    ...
    return (<section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-green-50 via-emerald-50 to-green-100" style={{ transform: `translateY(${scrollY * 0.5}px)` }}/>
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto w-full">
        <div className="animate-fade-in">
          {/* Main Logo */}
          <div className="mb-8">
            <img src="/lovable-uploads/6a15e91c-f372-4075-b626-ce095ce25ae6.png" alt="Refresh Logo" className="h-24 sm:h-32 lg:h-40 w-auto mx-auto mb-6"/>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a href="/auth" className="bg-green-600 text-white border-2 border-green-600 px-8 py-4 rounded-full text-lg font-semibold hover:bg-white hover:text-green-600 transform hover:scale-105 transition-all duration-300 w-full sm:w-auto text-center">
              Sign Up
            </a>
            <a href="/auth" className="border-2 border-green-600 text-green-600 px-8 py-4 rounded-full text-lg font-semibold hover:bg-green-600 hover:text-white transform hover:scale-105 transition-all duration-300 w-full sm:w-auto text-center">
              Login
            </a>
          </div>
        </div>
