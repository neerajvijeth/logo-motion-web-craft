            ...
            {user ? (
              ...
              <a 
                ...
                className={`bg-green-600 text-white px-6 py-2 rounded-full hover:bg-green-700 transition-colors font-medium ${
                  isActivePage('/auth') ? 'bg-green-700' : ''
                }`}
              >
                Login
              </a>
          ...
          <div className="bg-white/95 backdrop-blur-md border-t border-gray-200 py-4 rounded-b-2xl shadow-xl mx-4 mb-4">
            <nav className="flex flex-col space-y-2 px-4">
              {[
                ...
                ...(user ? [{ href: '#', label: 'Logout', isActive: false, isLogout: true }] : [{ href: '/auth', label: 'Login', isActive: isActivePage('/auth') }])
              ].map((item, index) => {
                if (item.isLogout) {
                  return (
                    <button
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`
                      ...
                      ${item.href === '/auth' ? 'bg-green-400' : 'bg-green-300'}
                    `}></div>
                  </a>
                );
              })}
