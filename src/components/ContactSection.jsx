      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`text-center mb-16 transition-all duration-1000 ${
          ...
          <p className="text-xl text-green-100 max-w-2xl mx-auto">
            Ready to revolutionize your agricultural operations? We'd love to hear from you and help you find the perfect robotics solution.
          </p>
        </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <div className="text-green-100">+1 (555) ROBOT-ARM</div>
                </div>
              </div>
              <div className="flex items-center">
                <div className="w-12 h-12 bg-white/10 rounded-full flex items-center justify-center mr-4">
                ...
                <div>
                  ...
                  <div className="text-green-100">info@refreshrobotics.com</div>
                </div>
              </div>
              <div className="flex items-center">
                <div className="w-12 h-12 bg-white/10 rounded-full flex items-center justify-center mr-4">
                ...
                <div>
                  ...
                  <div className="text-green-100">456 Innovation Drive, Tech Valley, CA 94301</div>
                </div>
              </div>
            </div>
          </div>
