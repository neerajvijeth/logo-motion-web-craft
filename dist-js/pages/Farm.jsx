...
const Farm = () => {
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-green-100">
      <Header />
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="relative mx-auto animate-fade-in delay-200">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl border border-green-200 overflow-hidden">
              ...
              <div ref={containerRef} className="w-full h-[500px] md:h-[600px] bg-gradient-to-br from-green-800 to-emerald-800" style={{ position: 'relative' }}/>
            </div>
          </div>
