      ...
      <Card className="w-full max-w-md relative z-10 shadow-2xl border-green-200 backdrop-blur-sm bg-white/95 animate-fade-in">
        <CardHeader className="text-center relative">
          <div className="animate-fade-in">
            <img src="/lovable-uploads/6a15e91c-f372-4075-b626-ce095ce25ae6.png" alt="Refresh Logo" className="h-16 w-auto mx-auto mb-4 hover:scale-110 transition-transform duration-300"/>
          </div>
        ...
        <CardContent className="space-y-6">
          <form onSubmit={handleSubmit} className="space-y-6 animate-fade-in delay-400">
            <div className="space-y-4">
              <div className="relative group">
                <Input type="email" placeholder="Enter your email" value={email} onChange={(e) => setEmail(e.target.value)} required className="border-green-200 focus:border-green-500 focus:ring-2 focus:ring-green-200 transition-all duration-300 pl-4 pr-4 py-3 bg-white/70 backdrop-blur-sm hover:bg-white/90"/>
              ...
              <div className="relative group">
                <Input type="password" placeholder="Enter your password" value={password} onChange={(e) => setPassword(e.target.value)} required className="border-green-200 focus:border-green-500 focus:ring-2 focus:ring-green-200 transition-all duration-300 pl-4 pr-4 py-3 bg-white/70 backdrop-blur-sm hover:bg-white/90"/>
                <div className="absolute inset-0 rounded-md bg-gradient-to-r from-green-400 to-emerald-500 opacity-0 group-hover:opacity-10 transition-opacity duration-300 pointer-events-none"></div>
              </div>
            </div>
            
            <Button type="submit" className="w-full bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-semibold py-3 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 relative overflow-hidden group" disabled={loading}>
          ...
          <div className="text-center animate-fade-in delay-600">
            ...
            <button onClick={() => setIsLogin(!isLogin)} className="mt-4 text-green-600 hover:text-green-700 font-medium transition-colors duration-300 hover:underline group">
